      ...
      <CardContent className="p-4">
        <div className="flex flex-col md:flex-row md:gap-6">
          ...
          <div className="flex-1 mb-4 md:mb-0">
            ...
            <div
              className="p-3 bg-white rounded-md border border-gray-200 min-h-[100px]"
          ...
          <div className="flex flex-row md:flex-col justify-end items-center space-x-2 md:space-x-0 md:space-y-2 mt-4 md:mt-0">
            <Button
              ...
              title="Akceptuj"
              data-testid={`flashcard-accept-button-${index}`}
            >
        ...
        {/* Status badge */}
        <div className="mt-4 flex justify-end" data-testid={`flashcard-status-badge-${index}`}>
          {getStatusBadge()}
        </div>
      </CardContent>
    </Card>
